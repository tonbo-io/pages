...
<div class="p-4 xs:px-10 bg-background-light apply-selection font-code">
	<div class="relative flex flex-col w-full min-h-screen mx-auto apply-container-responsive">
		...
		>
					...
					>
						<div class="fusio-icon-wrapper flex items-center gap-2">
							<img
								src="/fusio-icon.svg"
								alt="Fusio Icon"
								class="w-[7rem] transition-all duration-200"
							/>
							<p>-></p>
						</div>
			...
			>
				<div class="flex-1 flex w-full md:pl-[2rem]">
					...
					<div class="flex-1 relative mt-[2rem]">
						...
						<div class="flex-1 flex flex-col items-center justify-center">
							...
							<a
								class="border-2 border-tonbo-red p-[1rem] w-[8rem] hover:bg-tonbo-red hover:text-background-light text-center max-h-[3rem] mx-auto flex items-center justify-center"
