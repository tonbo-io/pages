...
<div class="bg-[#E7F1BE]">
	...
	<!-- <div
		class="m-auto h-[4rem] flex items-center justify-center text-center text-background-dark border-dashed border-background-dark mt-[6rem] mx-4 border-t-2 w-[1200px] sm:w-[800px] md:w-[1000px] lg:w-[1200px]"
	>
