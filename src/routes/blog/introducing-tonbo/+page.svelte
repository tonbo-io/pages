	...
	>
		...
		>
			...
			<p>
				...
				tasks like data clean-up and compaction to the background, LSM trees streamline the
				read/write process and reduce the load on the frontend.
			</p>
			...
			<p>
				...
				data structures into Arrow schemas. Tonbo leverages the features provided by Arrow/Parquet
				to support pushdown operations like limit, project, and filter:
			</p>
			<Structured />
			<p class="mt-[2rem]">
			...
			<p class="mt-[2rem]">
				...
				posts, we will describe in detail how we achieve this—bear witness!
			</p>
			<div class="w-full max-w-full overflow-x-auto">
				<pre
					class="inline-block p-4 font-mono text-xs whitespace-pre sm:text-sm md:text-base min-w-max leading-[1.3">
			...
			<pre
				class="break-words whitespace-pre-wrap font-code text-background-dark">	• Runtime Schema Declaration: Basic support for JavaScript (WASM) and Python.</pre>
			<pre
				class="break-words whitespace-pre-wrap font-code text-background-dark">	• S3 Integration: Implementation of tiered LSM Trees based on this integration.</pre>
			<p class="mt-[1rem]">
