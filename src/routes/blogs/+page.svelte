...
<div class="bg-background-light font-code min-h-screen">
	<div
		class="w-full sm:w-[600px] min-[836px]:w-[768px] md:w-[1000px] lg:w-[1200px] m-auto px-4 sm:px-0"
	>
		<!-- header -->
		...
		<div class="border-t border-black">
			{#each posts as post, i}
				{#if i === 0}
					<!-- Featured Post -->
					<div
						class="border-b border-black p-6 md:p-12 flex flex-col md:flex-row gap-12 bg-[#E4E6D9]"
					>
				...
				{:else}
					<!-- Regular Post -->
					<div
						class="border-black {i === posts.length - 1
							? ''
							: 'border-b'} py-6 px-4 md:px-8 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-12 bg-[#E4E6D9] hover:bg-[#D8DBC9] transition-colors"
					>
